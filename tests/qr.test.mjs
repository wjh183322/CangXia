...
test('phone already confirmed is a connecting state instead of asking for confirmation again',()=>{const result=vm.runInNewContext(qrPageScript(),{document:{body:{innerText:'已确认，正在登录'},querySelectorAll:()=>[]}});assert.equal(result.phase,'connecting');});

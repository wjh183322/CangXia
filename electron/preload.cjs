...
const methods = ['state','openAccount','sync','stopSync','addCollections','importLink','download','pause','resume','chooseRoot','openRoot','openFolder','openOriginal','deleteWorks','setTags','checkSource','refreshFiles'];
const api = {};
